  ...
  return (
     ...
     <Typography>{product.title.longTitle}</Typography>
            ...
            8 Ratings and 1 Review 
              <Box component="span"><img src={fassured} style={{width:77, marginLeft:20 }} alt='asax'/></Box>
            </Typography>
            <Typography>
            ...
            <SmallText>
                ...
                <Typography><StyledBadge/>Buy 2 items and save 5%; Buy 3 or more save 10% T&C</Typography>
